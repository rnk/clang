...
struct C: virtual A {
  // VTABLE-C: VFTable for 'C' (2 entries)
  // VTABLE-C-NEXT: 0 | void C::f()
  // VTABLE-C-NEXT: 1 | void A::z()

  // VTABLE-C: VFTable indices for 'C' (2 entries)
...
struct D: virtual A {
  ...
  // VTABLE-D: VFTable indices for 'D' (3 entries).
...
struct Z : virtual Y {
  // TEST1: VFTable for 'Test1::Z' (2 entries).
  // TEST1-NEXT: 0 | void A::f()
  // TEST1-NEXT: 1 | void A::z()

  // TEST1: VFTable indices for 'Test1::Z' (2 entries).
  // TEST1-NEXT: via vbtable index 1, vfptr at offset 0
  // TEST1-NEXT: 0 | void A::f()
  // TEST1-NEXT: 1 | void A::z()
};
...
struct X: virtual A, virtual B {
  ...
  // TEST2: VFTable indices for 'Test2::X' (4 entries).
  // TEST2-NEXT: via vfptr at offset 0
  // TEST2-NEXT: 0 | void Test2::X::h()
  // TEST2-NEXT: via vbtable index 1, vfptr at offset 0
  // TEST2-NEXT: 0 | void A::f()
  // TEST2-NEXT: 1 | void A::z()
  // TEST2-NEXT: via vbtable index 2, vfptr at offset 0
  // TEST2-NEXT: 0 | void B::g()
...
struct Y: virtual X {
  // TEST3: VFTable for 'Test3::Y' (2 entries).
  // TEST3-NEXT: 0 | void A::f()
  // TEST3-NEXT: 1 | void A::z()

  // TEST3: VFTable indices for 'Test3::Y' (2 entries).
  // TEST3-NEXT: via vbtable index 1, vfptr at offset 0
  // TEST3-NEXT: 0 | void A::f()
  // TEST3-NEXT: 1 | void A::z()
};
...
struct X: virtual C {
  ...
  // TEST4: VFTable for 'Test4::X' (2 entries).
  // TEST4-NEXT: 0 | void C::f()
  // TEST4-NEXT: [this adjustment: 12 non-virtual]
  // TEST4-NEXT: 1 | void A::z()

  // TEST4: VFTable indices for 'Test4::X' (2 entries).
  // TEST4-NEXT: via vbtable index 1, vfptr at offset 0
  // TEST4-NEXT: 0 | void C::f()
  // TEST4-NEXT: 1 | void A::z()
};
...
struct Y : virtual X {
  ...
  // TEST5: VFTable indices for 'Test5::Y' (4 entries).
  // TEST5-NEXT: via vfptr at offset 0
  // TEST5-NEXT: 0 | void Test5::Y::h()
  // TEST5-NEXT: via vbtable index 1, vfptr at offset 0
  // TEST5-NEXT: 0 | void A::f()
  // TEST5-NEXT: 1 | void A::z()
  // TEST5-NEXT: 2 | void Test5::X::g()
...
struct X : A, virtual Empty {
  // TEST6: VFTable for 'Test6::X' (2 entries).
  // TEST6-NEXT: 0 | void A::f()
  // TEST6-NEXT: 1 | void A::z()

  // TEST6: VFTable indices for 'Test6::X' (2 entries).
  // TEST6-NEXT: 0 | void A::f()
  // TEST6-NEXT: 1 | void A::z()
};
...
struct Y : virtual X {
  // TEST7: VFTable for 'Test7::Y' (2 entries).
  ...
  // TEST7: VFTable indices for 'Test7::Y' (2 entries).
  // TEST7-NEXT: via vbtable index 1, vfptr at offset 0
  // TEST7-NEXT: 0 | void C::f()
  // TEST7-NEXT: 1 | void A::z()
};
...
struct X : D, C {
  ...
  // TEST8: VFTable indices for 'Test8::X' (3 entries).
  // TEST8-NEXT: via vfptr at offset 0
  // TEST8-NEXT: 0 | void D::h()
...
struct Y : virtual X {
  ...
  // TEST9-Y: VFTable indices for 'Test9::Y' (3 entries).
  // TEST9-Y-NEXT: via vfptr at offset 0
  // TEST9-Y-NEXT: 0 | void Test9::Y::h()
  // TEST9-Y-NEXT: via vbtable index 1, vfptr at offset 0
  // TEST9-Y-NEXT: 0 | void A::f()
  // TEST9-Y-NEXT: 1 | void A::z()
...
struct Z : Y, virtual B {
  ...
  // TEST9-Z: VFTable indices for 'Test9::Z' (4 entries).
  // TEST9-Z-NEXT: via vfptr at offset 0
  // TEST9-Z-NEXT: 0 | void Test9::Y::h()
  // TEST9-Z-NEXT: via vbtable index 1, vfptr at offset 0
  // TEST9-Z-NEXT: 0 | void A::f()
  // TEST9-Z-NEXT: 1 | void A::z()
  // TEST9-Z-NEXT: via vbtable index 2, vfptr at offset 0
  // TEST9-Z-NEXT: 0 | void B::g()
};
...
struct W : Z, D, virtual A, virtual B {
  ...
  // TEST9-W: VFTable indices for 'Test9::W' (6 entries).
  // TEST9-W-NEXT: via vfptr at offset 0
  // TEST9-W-NEXT: 0 | void Test9::Y::h()
  // TEST9-W-NEXT: via vfptr at offset 8
  // TEST9-W-NEXT: 0 | void D::h()
  // TEST9-W-NEXT: via vbtable index 1, vfptr at offset 0
  // TEST9-W-NEXT: 0 | void A::f()
  // TEST9-W-NEXT: 1 | void A::z()
  // TEST9-W-NEXT: via vbtable index 2, vfptr at offset 0
  // TEST9-W-NEXT: 0 | void B::g()
  // TEST9-W-NEXT: via vbtable index 3, vfptr at offset 0
  // TEST9-W-NEXT: 0 | void D::f()
};
...
struct X : virtual C, virtual A {
  // TEST10: VFTable for 'Test10::X' (2 entries).
  // TEST10-NEXT: 0 | void Test10::X::f()
  // TEST10-NEXT: 1 | void A::z()

  // TEST10: VFTable indices for 'Test10::X' (2 entries).
...
struct W : Z {
  // RET-W: VFTable for 'return_adjustment::W' (2 entries).
...
struct T : W {
  // RET-T: VFTable for 'return_adjustment::T' (3 entries).
