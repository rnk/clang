...
struct Test1: A, B {
  ...
  // NO-THUNKS-Test1: VFTable indices for 'no_thunks::Test1' (3 entries)
  // NO-THUNKS-Test1-NEXT: via vfptr at offset 0
  // NO-THUNKS-Test1-NEXT: 0 | void no_thunks::Test1::f()
  // NO-THUNKS-Test1-NEXT: via vfptr at offset 4
  // NO-THUNKS-Test1-NEXT: 0 | void B::g()
  // NO-THUNKS-Test1-NEXT: 1 | void B::h()
...
struct Test2: A, B {
  ...
  // NO-THUNKS-Test2: VFTable indices for 'no_thunks::Test2' (3 entries).
  // NO-THUNKS-Test2-NEXT: via vfptr at offset 0
  // NO-THUNKS-Test2-NEXT: 0 | void A::f()
...
struct Test3: A, B {
  ...
  // NO-THUNKS-Test3: VFTable indices for 'no_thunks::Test3' (4 entries).
  // NO-THUNKS-Test3-NEXT: via vfptr at offset 0
  // NO-THUNKS-Test3-NEXT: 0 | void A::f()
  // NO-THUNKS-Test3-NEXT: 1 | void no_thunks::Test3::i()
  // NO-THUNKS-Test3-NEXT: via vfptr at offset 4
  // NO-THUNKS-Test3-NEXT: 0 | void B::g()
  // NO-THUNKS-Test3-NEXT: 1 | void B::h()
...
struct Test4 : Empty, A {
  // NO-THUNKS-Test4: VFTable for 'no_thunks::Test4' (1 entries)
...
struct Test5: Test1, Test2 {
  ...
  // NO-THUNKS-Test5: VFTable indices for 'no_thunks::Test5' (6 entries).
  // NO-THUNKS-Test5-NEXT: via vfptr at offset 0
  // NO-THUNKS-Test5-NEXT: 0 | void no_thunks::Test1::f()
  // NO-THUNKS-Test5-NEXT: 1 | void no_thunks::Test5::z()
  // NO-THUNKS-Test5-NEXT: via vfptr at offset 4
  // NO-THUNKS-Test5-NEXT: 0 | void B::g()
  // NO-THUNKS-Test5-NEXT: 1 | void B::h()
  // NO-THUNKS-Test5-NEXT: via vfptr at offset 8
  // NO-THUNKS-Test5-NEXT: 0 | void A::f()
  // NO-THUNKS-Test5-NEXT: via vfptr at offset 12
  // NO-THUNKS-Test5-NEXT: 0 | void no_thunks::Test2::g()
...
struct Test6: Test1 {
  ...
  // NO-THUNKS-Test6: VFTable indices for 'no_thunks::Test6' (3 entries).
  // NO-THUNKS-Test6-NEXT: via vfptr at offset 0
  // NO-THUNKS-Test6-NEXT: 0 | void no_thunks::Test6::f()
  // NO-THUNKS-Test6-NEXT: via vfptr at offset 4
  // NO-THUNKS-Test6-NEXT: 0 | void B::g()
  // NO-THUNKS-Test6-NEXT: 1 | void B::h()
...
struct Test7: Test2 {
  ...
  // NO-THUNKS-Test7: VFTable indices for 'no_thunks::Test7' (3 entries).
  // NO-THUNKS-Test7-NEXT: via vfptr at offset 0
  // NO-THUNKS-Test7-NEXT: 0 | void A::f()
...
struct Test8: Test3 {
  ...
  // NO-THUNKS-Test8: VFTable indices for 'no_thunks::Test8' (4 entries).
  // NO-THUNKS-Test8-NEXT: via vfptr at offset 0
  // NO-THUNKS-Test8-NEXT: 0 | void A::f()
  // NO-THUNKS-Test8-NEXT: 1 | void no_thunks::Test3::i()
...
struct Test9: A, D {
  ...
  // NO-THUNKS-Test9: VFTable indices for 'no_thunks::Test9' (3 entries).
  // NO-THUNKS-Test9-NEXT: via vfptr at offset 0
  // NO-THUNKS-Test9-NEXT: 0 | void A::f()
  // NO-THUNKS-Test9-NEXT: 1 | void no_thunks::Test9::h()
  // NO-THUNKS-Test9-NEXT: via vfptr at offset 4
  // NO-THUNKS-Test9-NEXT: 1 | void no_thunks::D::g()
...
struct Test1: A, D {
  ...
  // PURE-VIRTUAL-Test1: VFTable indices for 'pure_virtual::Test1' (3 entries).
  // PURE-VIRTUAL-Test1-NEXT: via vfptr at offset 0
  // PURE-VIRTUAL-Test1-NEXT: 0 | void A::f()
...
struct Test1 : B, C {
  ...
  // THIS-THUNKS-Test1: VFTable indices for 'this_adjustment::Test1' (2 entries).
  // THIS-THUNKS-Test1-NEXT: 0 | void this_adjustment::Test1::g()
  // THIS-THUNKS-Test1-NEXT: 1 | void B::h()
...
struct Test2 : A, B, C {
  ...
  // THIS-THUNKS-Test2: VFTable indices for 'this_adjustment::Test2' (3 entries).
  // THIS-THUNKS-Test2-NEXT: via vfptr at offset 0
  // THIS-THUNKS-Test2-NEXT: 0 | void A::f()
...
struct Test3: no_thunks::Test1, no_thunks::Test2 {
  ...
  // THIS-THUNKS-Test3: VFTable indices for 'this_adjustment::Test3' (3 entries).
...
struct Test1 : Ret1 {
  // RET-THUNKS-Test1: VFTable for 'return_adjustment::Test1' (2 entries).
  ...
  // RET-THUNKS-Test1-NEXT: 1 | this_adjustment::Test1 *return_adjustment::Test1::foo()
...
struct Test2 : Test1 {
  // RET-THUNKS-Test2: VFTable for 'return_adjustment::Test2' (3 entries).
  ...
  // RET-THUNKS-Test2-NEXT: 1 | return_adjustment::Ret2 *return_adjustment::Test2::foo()
...
struct Test3: B, Ret1 {
  // RET-THUNKS-Test3: VFTable for 'return_adjustment::Ret1' in 'return_adjustment::Test3' (2 entries).
  ...
  // RET-THUNKS-Test3-NEXT: 1 | this_adjustment::Test1 *return_adjustment::Test3::foo()

  // RET-THUNKS-Test3: VFTable indices for 'return_adjustment::Test3' (3 entries).
  // RET-THUNKS-Test3-NEXT: via vfptr at offset 0
...
struct Test4 : Test3 {
  ...
  // RET-THUNKS-Test4: VFTable for 'return_adjustment::Ret1' in 'return_adjustment::Test3' in 'return_adjustment::Test4' (3 entries).
  ...
  // RET-THUNKS-Test4-NEXT: 1 | return_adjustment::Ret2 *return_adjustment::Test4::foo()
  ...
  // RET-THUNKS-Test4: VFTable indices for 'return_adjustment::Test4' (3 entries).
  // RET-THUNKS-Test4-NEXT: -- accessible via vfptr at offset 0 --
  // RET-THUNKS-Test4-NEXT:   0 | void B::g()
  // RET-THUNKS-Test4-NEXT:   1 | void B::h()
...
struct Test5 : Ret1, Test1 {
  // RET-THUNKS-Test5: VFTable for 'return_adjustment::Ret1' in 'return_adjustment::Test5' (2 entries).
  ...
  // RET-THUNKS-Test5-NEXT: 1 | return_adjustment::Ret2 *return_adjustment::Test5::foo()

  // RET-THUNKS-Test5: VFTable for {{.*}} 'return_adjustment::Test1' in 'return_adjustment::Test5' (3 entries).
  // RET-THUNKS-Test5-NEXT: 0 | return_adjustment::Ret2 *return_adjustment::Test5::foo()
  // RET-THUNKS-Test5-NEXT:     [return adjustment: 8 non-virtual]
